...
Removed Summarypage, moved csquotes to cls.

### Removed
- Removed never used Summarypage

### Changed
- Moved csquotes to .cls file and include it only when Czech or Slovak is used.


## [1.6.2] - 25. 2. 2026

Set higher penalty for widows and orphans so they do not happen at all.

### Changed
- Higher penalty for widows and orphans.


## [1.6.1] - 18. 2. 2026

Fix of bibliography not appearing in table of content.

### Fixed
- Added a command to show bibliography in ToC.
