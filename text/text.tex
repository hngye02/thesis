...
\begin{table}[htbp]
\centering
\caption{Landmark latency and accuracy on Redmi at BS=1 with XNNPACK. LM inf. means landmark inference and ms means milliseconds. Bold values mark the lower latency and lower error within each model pair.}
...
\begin{figure}[htbp]
    ...
    \caption[Landmark-latency batch scaling on Redmi for PFLD-MNv2-1.0]{Landmark-inference latency batch scaling on Redmi for PFLD-MNv2-1.0 using XNNPACK variants. Lower latency is better.}
...
\begin{figure}[htbp]
    ...
    \caption[Landmark-latency batch scaling on Redmi for PipNet ResNet18]{Landmark-inference latency batch scaling on Redmi for PipNet ResNet18 using XNNPACK variants. Lower latency is better.}
    \label{fig:focus-batch-pipnet}
\end{figure}

\begin{table}[htbp]
\centering
\caption{Landmark-inference latency batch scaling on Redmi. LM means landmark inference and BS means batch size. Bold marks the lowest latency in each batch-size column.}
...
\begin{table}[htbp]
\centering
\caption{Landmark-inference latency batch scaling for PFLD-MNv2-1.0 with INT8 XNNPACK across three devices; lower is better. Bold marks the best value in each batch-size column.}
...
\begin{table}[htbp]
\centering
\caption{Landmark-inference latency batch scaling for PipNet-R18 with INT8 XNNPACK across three devices; lower is better. Bold marks the best value in each batch-size column.}
...
\begin{figure}[htbp]
    ...
    \caption{Landmark-inference latency batch scaling on iPhone 14 for PFLD-MNv2-1.0.}
...
\begin{figure}[htbp]
    ...
    \caption{Landmark-inference latency batch scaling on iPhone 14 for PipNet ResNet18.}
    \label{fig:iphone-batch-pipnet}
\end{figure}

\begin{table}[htbp]
\centering
\caption{Landmark-inference latency batch scaling on iPhone 14. LM means landmark inference and BS means batch size. Bold marks the lowest latency in each batch-size column.}
