...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.95\linewidth]{images/benchmarks/combined/combined_04_bs1_xnnpack_landmark_latency.png}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.95\linewidth]{../benchmarks/results/combined/charts/focus_01_bs1_landmark_latency_backend_quant.png}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.95\linewidth]{../benchmarks/results/combined/charts/focus_03_batch_scaling_landmark_latency__pfld_mobilenetv2_10.png}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.95\linewidth]{../benchmarks/results/combined/charts/focus_03_batch_scaling_landmark_latency__pipnet_resnet18.png}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.95\linewidth]{../benchmarks/results/combined/charts/device_iphone_14/focus_03_batch_scaling_landmark_latency__pfld_mobilenetv2_10.png}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.95\linewidth]{../benchmarks/results/combined/charts/device_iphone_14/focus_03_batch_scaling_landmark_latency__pipnet_resnet18.png}
\end{figure}
